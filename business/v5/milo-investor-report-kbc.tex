...
\begin{center}
    \statbox{kbcblue}{Year 3 Users}{10,000}
    \hspace{0.2cm}
    \statbox{successgreen}{Year 3 Revenue}{\$850K}
    \hspace{0.2cm}
    \statbox{datapurple}{Operating Margin}{17\%}
    \hspace{0.2cm}
    \statbox{miloprimary}{LTV:CAC}{4:1+}
\end{center}
...
\begin{center}
\infobox{kbcblue}{
    {\Large\textcolor{kbcblue}{\textbf{Seed Funding: \$350K}}}\\[15pt]
    \begin{minipage}[t]{0.48\textwidth}
        \textbf{Use of Funds:}
        \begin{itemize}[leftmargin=1.5em, itemsep=4pt]
            \item Product Development: 30\% (\$105K)
            \item GDPR Compliance: 15\% (\$52K)
            \item User Acquisition: 25\% (\$87K)
            \item B2B Sales Development: 15\% (\$52K)
            \item Operations \& Runway: 15\% (\$54K)
        \end{itemize}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{itemize}[leftmargin=1.5em, itemsep=4pt]
            ...
            \item Q4 2026: 2,000 Paid Users
            \item Q2 2027: First B2B Pipeline
            \item Q4 2027: 5,000 Paid Users
            \item Q4 2028: 10,000 Users, Profitability
        \end{itemize}
    \end{minipage}
}
\end{center}
...
\begin{center}
    \revenuestream{appstoreblue}{B2C Subscriptions}{\$528K}{62\% of revenue}
    \hspace{0.3cm}
    \revenuestream{datapurple}{B2B Data Licensing}{\$252K}{30\% of revenue}
    \hspace{0.3cm}
    \revenuestream{analyticsteal}{Analytics Reports}{\$70K}{8\% of revenue}
\end{center}
...
\textbf{Silver} & 25/mo & \$5.99 & \$54.99 & \$62 & 3.6:1 \\
\rowcolor{goldcolor!10}
\textbf{Gold} & 40/mo & \$6.49 & \$59.99 & \$67 & 3.9:1 \\
\rowcolor{platinumcolor!10}
\textbf{Platinum} & 150/mo & \$17.49 & \$149.99 & \$155 & 9.1:1 \\
\midrule
\rowcolor{successgreen!10}
\textbf{Blended} & -- & -- & -- & \textbf{\$68} & \textbf{4:1+} \\
\bottomrule
\end{tabular}
\end{center}
...
\midrule
\textbf{Paid Users (End of Year)} & 2,000 & 5,000 & 10,000 \\
\rowcolor{lightbg}
\textbf{Total Revenue} & \$106K & \$264K & \$850K \\
\quad B2C Subscriptions & \$106K & \$264K & \$528K \\
\rowcolor{lightbg}
\quad B2B Data Licensing & \$0 & \$0 & \$252K \\
...
\begin{tikzpicture}
    \node[fill=successgreen!12, draw=successgreen, line width=1.5pt, rounded corners=10pt,
        ...
        \textcolor{darktext}{Break-even: Month 30 | Cash flow positive: Year 3 | 17\% operating margin by Year 3}
    };
\end{tikzpicture}
\end{center}
...
\toprule
\rowcolor{kbcblue!15}
\textbf{Scenario} & \textbf{Y3 Revenue} & \textbf{Y3 Profit} & \textbf{Valuation (5x)} & \textbf{Probability} \\
\midrule
\rowcolor{dangerred!10}
Bear Case & \$500K & (\$20K) & \$2.5M & 20\% \\
\rowcolor{lightbg}
\textbf{Base Case} & \textbf{\$850K} & \textbf{\$142K} & \textbf{\$4.25M} & 60\% \\
\rowcolor{successgreen!10}
Bull Case & \$1.2M & \$350K & \$6M & 20\% \\
\bottomrule
\end{tabular}
\end{center}
...
\toprule
\rowcolor{kbcblue!15}
\textbf{Scenario} & \textbf{Valuation (Y3)} & \textbf{Multiple} & \textbf{Return on \$350K} \\
\midrule
\rowcolor{lightbg}
Conservative & \$2.5M & 5x & 1.5-2x \\
\textbf{Base Case} & \textbf{\$4.25M} & \textbf{5x} & \textbf{3-4x} \\
\rowcolor{successgreen!10}
Optimistic & \$6M & 5x & 5-6x \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tikzpicture}
    \node[fill=kbcblue!8, draw=kbcblue, line width=3pt, rounded corners=15pt,
          ...
          drop shadow={shadow xshift=3pt, shadow yshift=-3pt, opacity=0.2}] {
        {\Huge\textcolor{kbcblue}{\textbf{\$350K}}}\\[15pt]
        ...
        \begin{minipage}[t]{0.48\textwidth}
            ...
            \begin{itemize}[leftmargin=1.5em, itemsep=4pt]
                ...
                \item 10,000 users in 3 years
                \item \$850K annual revenue
                \item Profitability at Month 30
