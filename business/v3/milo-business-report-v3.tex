...
\begin{itemize}[leftmargin=2em, itemsep=3pt]
    \item Receipt scanner market growing 11.1\% annually (\$1.97B → \$5.12B by 2033)
...
\textbf{1. Receipt Scanner Apps: \$1.97B → \$5.12B (11.1\% CAGR)}
\begin{itemize}[leftmargin=2em, itemsep=3pt]
...
\textbf{2. Consumer Data Monetization: \$4.05B → \$16.11B (17.6\% CAGR)}
\begin{itemize}[leftmargin=2em, itemsep=3pt]
...
\begin{center}
\sourcebox{Data monetization market: Fortune Business Insights 2025 (\$4.05B in 2025, 17.6\% CAGR); Enterprise sales cycles: SaaStr Industry Benchmarks; Panelist value: Market research industry standards (\$35-75/year per panelist)}
\end{center}
...
Data monetization: \$4.05B & Fortune Business Insights & 2025 \\
\rowcolor{lightbg}
...
\begin{enumerate}[leftmargin=2em, itemsep=4pt]
    ...
    \item \textbf{The market is massive} -- \$7.32T wellness + \$5.12B receipt scanning + \$16.11B data monetization
...
\textbf{Fortune Business Insights (2025)}\\
Data Monetization Market Size, Share \& Forecast - Market valued at \$4.05B in 2025, projected to reach \$16.11B by 2034 (17.6\% CAGR)\\
...
\url{https://onesignal.com/mobile-app-benchmarks-2024}\\
Customer Engagement Report: \url{https://onesignal.com/the-2024-state-of-customer-engagement-report}
...
"Intuit Is Closing Personal-Finance App Mint, Shifts Users to Credit Karma" - 3.6M active users as of 2021 (Note: Bloomberg requires subscription)\\
